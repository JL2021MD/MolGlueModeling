...
&cntrl
 ...
 restraintmask=":1-395 &!@H=", ! atoms to be restrained (all in BRD4 but not H)
...
&cntrl
 ...
 cut=  8,        ! Nonbonded cutoff in Angstroms
 ntr=0,            ! Turn on restraints 
 restraintmask=":396>@8&!:WAT,Na+", ! atoms to be restrained (all in residue 1-253 but not H)
 restraint_wt=10, ! force constant for restraint
...
&general                                                                                                                                   
  ...
  keep_files=0, startframe=1, endframe=1000
/                                                                                                                                          
&gb
  igb=5,                                          
